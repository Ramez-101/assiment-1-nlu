 ...
 "cells": [
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Requirement already satisfied: faiss-cpu==1.7.0 in /Users/jaskanwal/opt/anaconda3/envs/nlu/lib/python3.9/site-packages (1.7.0)\n"
     ]
    }
   ],
   "source": [
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Reusing dataset squad (/Users/jaskanwal/.cache/huggingface/datasets/squad/plain_text/1.0.0/d6ec3ceb99ca480ce37cdd35555d6cb2511d223b9150cce08a837ef62ffea453)\n"
     ]
    },
    {
     "data": {
      "application/vnd.jupyter.widget-view+json": {
       "model_id": "be9ba66f209c459caa4d35f701d093cf",
       "version_major": 2,
       "version_minor": 0
      },
      "text/plain": [
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "\n",
      "Q: The Pleistocene epoch takes place during which period?\n",
      "\n",
      "A:\n"
     ]
    }
   ...
   "outputs": [
    {
     ...
     "text": [
      "0.07687130375864559\n",
      "CPU times: user 10min 28s, sys: 5min 3s, total: 15min 31s\n",
      "Wall time: 10min 19s\n"
     ]
    }
   ],
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "[Apr 21, 10:27:15] #> Loading collection...\n",
      "0M \n"
     ]
    },
    {
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "[Apr 21, 10:27:16] #> Loading collection...\n",
      "0M \n"
     ]
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "/Users/jaskanwal/opt/anaconda3/envs/nlu/lib/python3.9/site-packages/torch/cuda/amp/grad_scaler.py:115: UserWarning: torch.cuda.amp.GradScaler is enabled, but CUDA is not available.  Disabling.\n",
    ...
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "[Apr 21, 10:27:19] #> Building the emb2pid mapping..\n",
      "[Apr 21, 10:27:19] len(self.emb2pid) = 14968345\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "outputs": [
    ...
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "/Users/jaskanwal/opt/anaconda3/envs/nlu/lib/python3.9/site-packages/torch/autocast_mode.py:141: UserWarning: User provided device_type of 'cuda', but CUDA is not available. Disabling\n",
   ...
   "outputs": [
    {
     ...
     "text": [
      "0.05521738473591853\n",
      "CPU times: user 19min 22s, sys: 6min 53s, total: 26min 16s\n",
      "Wall time: 11min 20s\n"
     ]
    }
   ],
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "    if \" | \" in passage:\n",
    "        my_title, my_background = passage.split(\" | \", 1)\n",
    "    else:\n",
    "        my_title, my_background = \"Retrieved passage\", passage\n",
    "    \n",
    "    segs += [\n",
    "            f\"Title: {my_title}\",\n",
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       ...
       "  1.0,\n",
       "  1.0],\n",
       " 'generated_answer': \" It's been a while since I've played it. I've played it for\",\n",
       " 'generated_answer_probs': [1.0,\n",
       "  1.0,\n",
       "  0.3275485634803772,\n",
       "  1.0,\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "        \"\"\"\n",
    "        ##### YOUR CODE HERE\n",
    "        train_exs = squad_index.select_relevant_docs(f\"{passage} {question}\", k)\n",
    "        segs = []\n",
    "        for t in train_exs:\n",
    "            segs += [\n",
    "                f\"Title: {t.title}\",\n",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "The following are the `macro_f1` scores as a function of `temperature` and `num_beams` parameters.\n",
    "\n",
   ...
   "outputs": [
    {
     "data": {
      "application/vnd.jupyter.widget-view+json": {
       "model_id": "0178a1a62e7b4e55955a6b914c75f4e1",
       "version_major": 2,
       "version_minor": 0
      },
      "text/plain": [
